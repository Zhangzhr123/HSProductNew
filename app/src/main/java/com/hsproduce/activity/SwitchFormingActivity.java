...
//                        Toast.makeText(SwitchPlanActivity.this, "计划查询成功！", Toast.LENGTH_LONG).show();
                        ...
                        if(datas.get(0).getState().equals("30")){
                            Toast.makeText(SwitchFormingActivity.this, "查询成功，没有正在执行的计划！", Toast.LENGTH_LONG).show();
                        }else if(datas.get(0).getState().equals("20")){
                            Toast.makeText(SwitchFormingActivity.this, "查询成功，没有可以替换的计划！", Toast.LENGTH_LONG).show();
                        }
                    }else{
